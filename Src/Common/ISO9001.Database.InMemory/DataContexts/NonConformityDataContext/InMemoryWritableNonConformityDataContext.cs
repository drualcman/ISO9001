...
{
    public Task AddNonConformityAsync(Core.Entities.NonConformity nonConformityMaster)
    {
        var NonConformityRecord = new Entities.NonConformity
        {
    ...
    public Task AddNonConformityDetailAsync(Core.Entities.NonConformityDetail nonConformityDetail, Guid id)
    {
